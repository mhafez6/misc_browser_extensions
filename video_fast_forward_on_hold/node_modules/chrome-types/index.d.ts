...
declare namespace chrome {
  ...
  export namespace webRequest {
     ...
     * @chrome-enum "extraHeaders" Specifies that headers can violate Cross-Origin Resource Sharing (CORS).
     * @chrome-enum "securityInfo" Specifies that the SecurityInfo should be included in the event.
     * @chrome-enum "securityInfoRawDer" Specifies that the SecurityInfo with raw bytes of certificates should be included in the event.
     * @since Chrome 44
     */
